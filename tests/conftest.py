...
def plan_home_work_home():
    plan = Plan(
        home_area='h',
        home_location=Location(loc=Point(0, 0), area='h')
    )
    plan.add(Activity(
        seq=1, act='home', area='h', loc=Point(0, 0),
        start_time=mtdt(0), end_time=mtdt(5 * 60)
    ))
    plan.add(Leg(
        seq=1, mode='car', start_area='h', end_area='w',
        start_loc=Point(0, 0), end_loc=Point(1, 2),
        start_time=mtdt(5 * 60), end_time=mtdt(6 * 60)
    ))
    plan.add(Activity(
        seq=2, act='work', area='w', loc=Point(1, 2),
        start_time=mtdt(6 * 60), end_time=mtdt(17 * 60)
    ))
    plan.add(Leg(
        seq=2, mode='car', start_area='w', end_area='h',
        start_loc=Point(1, 2), end_loc=Point(0, 0),
        start_time=mtdt(17 * 60), end_time=mtdt(18 * 60)
    ))
    plan.add(Activity(
        seq=3, act='home', area='h', loc=Point(0, 0),
        start_time=mtdt(18 * 60), end_time=END_OF_DAY))
...
def plan_home_work_home_shop_home():
    ...
    plan.add(Activity(
        seq=3, act='home', area='h', loc=Point(0, 0),
        start_time=mtdt(18 * 60), end_time=mtdt(19 * 60)))
    plan.add(Leg(
        seq=3, mode='car', start_area='h', end_area='b',
        start_loc=Point(0, 0), end_loc=Point(1, 2),
        start_time=mtdt(19 * 60), end_time=mtdt(20 * 60)
    ))
    plan.add(Activity(
        seq=4, act='shop', area='c', loc=Point(2, 2),
        start_time=mtdt(20 * 60), end_time=mtdt(22 * 60)
    ))
    plan.add(Leg(
        seq=4, mode='car', start_area='c', end_area='h',
        start_loc=Point(2, 2), end_loc=Point(0, 0),
        start_time=mtdt(22 * 60), end_time=mtdt(23 * 60)
    ))
    plan.add(Activity(
        seq=5, act='home', area='h', loc=Point(0, 0),
        start_time=mtdt(23 * 60), end_time=END_OF_DAY))
...
def plan_home_work_shop_home():
    ...
    plan.add(Leg(
        seq=2, mode='car', start_area='w', end_area='a',
        start_loc=Point(1, 2), end_loc=Point(0, 0),
        start_time=mtdt(17 * 60), end_time=mtdt(18 * 60)
    ))
    plan.add(Activity(
        seq=3, act='shop', area='c', loc=Point(2, 2),
        start_time=mtdt(18 * 60), end_time=mtdt(19 * 60)
    ))
    plan.add(Leg(
        seq=3, mode='car', start_area='c', end_area='h',
        start_loc=Point(2, 2), end_loc=Point(0, 0),
        start_time=mtdt(19 * 60), end_time=mtdt(22 * 60)
    ))
    plan.add(Activity(
        seq=4, act='home', area='h', loc=Point(0, 0),
        start_time=mtdt(22 * 60), end_time=END_OF_DAY))
...
def plan_other_work_shop_other():
    ...
    plan.add(Activity(
        seq=1, act='other', area='h', loc=Point(0, 0),
        start_time=mtdt(0), end_time=mtdt(5 * 60)
    ))
    plan.add(Leg(
        seq=1, mode='car', start_area='h', end_area='w',
    ...
    plan.add(Activity(
        seq=4, act='other', area='h', loc=Point(0, 0),
        start_time=mtdt(22 * 60), end_time=END_OF_DAY))
...
def plan_home_work_shop_work_home():
    ...
    plan.add(Activity(
        seq=2, act='work', area='w', loc=Point(1, 2),
        start_time=mtdt(6 * 60), end_time=mtdt(12 * 60)
    ))
    plan.add(Leg(
        seq=2, mode='car', start_area='w', end_area='c',
        start_loc=Point(1, 2), end_loc=Point(2, 2),
        start_time=mtdt(12 * 60), end_time=mtdt(13 * 60)
    ))
    plan.add(Activity(
        seq=3, act='shop', area='c', loc=Point(2, 2),
        start_time=mtdt(13 * 60), end_time=mtdt(14 * 60)
    ))
    plan.add(Leg(
        seq=3, mode='car', start_area='c', end_area='w',
        start_loc=Point(2, 2), end_loc=Point(1, 2),
        start_time=mtdt(14 * 60), end_time=mtdt(15 * 60)
    ))
    plan.add(Activity(
        seq=4, act='work', area='w', loc=Point(1, 2),
        start_time=mtdt(15 * 60), end_time=mtdt(17 * 60)
    ))
    plan.add(Leg(
        seq=4, mode='car', start_area='w', end_area='h',
        start_loc=Point(1, 2), end_loc=Point(0, 0),
        start_time=mtdt(17 * 60), end_time=mtdt(18 * 60)
    ))
    plan.add(Activity(
        seq=5, act='home', area='h', loc=Point(0, 0),
        start_time=mtdt(21 * 60), end_time=END_OF_DAY))
...
def plan_home_shop_home():
    ...
    plan.add(Leg(
        seq=1, mode='car', start_area='h', end_area='b',
        start_loc=Point(0, 0), end_loc=Point(1, 2),
        start_time=mtdt(5 * 60), end_time=mtdt(6 * 60)
    ))
    plan.add(Activity(
        seq=2, act='shop', area='b', loc=Point(1, 2),
        start_time=mtdt(6 * 60), end_time=mtdt(17 * 60)
    ))
    plan.add(Leg(
        seq=2, mode='car', start_area='b', end_area='h',
        start_loc=Point(1, 2), end_loc=Point(0, 0),
        start_time=mtdt(17 * 60), end_time=mtdt(18 * 60)
    ))
    plan.add(Activity(
...
def plan_home_shop_shop_home():
    ...
    plan.add(Leg(
        seq=2, mode='car', start_area='b', end_area='c',
        start_loc=Point(1, 2), end_loc=Point(2, 2),
        start_time=mtdt(17 * 60), end_time=mtdt(18 * 60)
    ))
    plan.add(Activity(
        seq=3, act='shop', area='c', loc=Point(2, 2),
        start_time=mtdt(18 * 60), end_time=mtdt(20 * 60)
    ))
    plan.add(Leg(
        seq=3, mode='car', start_area='c', end_area='h',
        start_loc=Point(2, 2), end_loc=Point(0, 0),
        start_time=mtdt(20 * 60), end_time=mtdt(21 * 60)
    ))
    plan.add(Activity(
        seq=4, act='home', area='h', loc=Point(0, 0),
        start_time=mtdt(21 * 60), end_time=END_OF_DAY))
...
def plan_home_shop_shop_home_shop_shop_home():
    ...
    plan.add(Leg(
        seq=1, mode='car', start_area='h', end_area='b',
        start_loc=Point(0, 0), end_loc=Point(1, 2),
        start_time=mtdt(2 * 60), end_time=mtdt(3 * 60)
    ))
    plan.add(Activity(
        seq=2, act='shop', area='b', loc=Point(1, 2),
        start_time=mtdt(3 * 60), end_time=mtdt(4 * 60)
    ))
    plan.add(Leg(
        seq=2, mode='car', start_area='b', end_area='c',
        start_loc=Point(1, 2), end_loc=Point(2, 2),
        start_time=mtdt(4 * 60), end_time=mtdt(5 * 60)
    ))
    plan.add(Activity(
        seq=3, act='shop', area='c', loc=Point(2, 2),
        start_time=mtdt(5 * 60), end_time=mtdt(6 * 60)
    ...
    plan.add(Leg(
        seq=3, mode='car', start_area='c', end_area='h',
        start_loc=Point(2, 2), end_loc=Point(0, 0),
        start_time=mtdt(7 * 60), end_time=mtdt(8 * 60)
    ))
    plan.add(Activity(
        seq=4, act='home', area='b', loc=Point(0, 0),
        start_time=mtdt(8 * 60), end_time=mtdt(12 * 60)
    ))
    plan.add(Leg(
        seq=4, mode='car', start_area='h', end_area='c',
        start_loc=Point(0, 0), end_loc=Point(2, 2),
        start_time=mtdt(12 * 60), end_time=mtdt(13 * 60)
    ))
    plan.add(Activity(
        seq=5, act='shop', area='c', loc=Point(2, 2),
        start_time=mtdt(13 * 60), end_time=mtdt(14 * 60)
    ))
    plan.add(Leg(
        seq=5, mode='car', start_area='c', end_area='b',
        start_loc=Point(2, 2), end_loc=Point(1, 1),
        start_time=mtdt(14 * 60), end_time=mtdt(15 * 60)
    ))
    plan.add(Activity(
        seq=6, act='shop', area='b', loc=Point(1, 1),
        start_time=mtdt(15 * 60), end_time=mtdt(17 * 60)
    ))
    plan.add(Leg(
        seq=6, mode='car', start_area='b', end_area='h',
        start_loc=Point(1, 1), end_loc=Point(0, 0),
        start_time=mtdt(17 * 60), end_time=mtdt(18 * 60)
    ))
    plan.add(Activity(
        seq=7, act='home', area='h', loc=Point(0, 0),
        start_time=mtdt(21 * 60), end_time=END_OF_DAY))
...
def plan_home_shop_shop_work_shop_shop_home():
    ...
    plan.add(Leg(
        seq=1, mode='car', start_area='h', end_area='z',
        start_loc=Point(0, 0), end_loc=Point(1, 2),
        start_time=mtdt(2 * 60), end_time=mtdt(3 * 60)
    ))
    plan.add(Activity(
        seq=2, act='shop', area='z', loc=Point(1, 2),
        start_time=mtdt(3 * 60), end_time=mtdt(4 * 60)
    ))
    plan.add(Leg(
        seq=2, mode='car', start_area='z', end_area='z',
        start_loc=Point(1, 2), end_loc=Point(2, 2),
        start_time=mtdt(4 * 60), end_time=mtdt(5 * 60)
    ))
    plan.add(Activity(
        seq=3, act='shop', area='z', loc=Point(2, 2),
        start_time=mtdt(5 * 60), end_time=mtdt(6 * 60)
    ))
    plan.add(Leg(
        seq=3, mode='car', start_area='z', end_area='w',
        start_loc=Point(2, 2), end_loc=Point(0, 0),
        start_time=mtdt(7 * 60), end_time=mtdt(8 * 60)
    ))
    plan.add(Activity(
        seq=4, act='work', area='w', loc=Point(0, 0),
        start_time=mtdt(8 * 60), end_time=mtdt(12 * 60)
    ))
    plan.add(Leg(
        seq=4, mode='car', start_area='w', end_area='z',
        start_loc=Point(0, 0), end_loc=Point(2, 2),
        start_time=mtdt(12 * 60), end_time=mtdt(13 * 60)
    ))
    plan.add(Activity(
        seq=5, act='shop', area='z', loc=Point(2, 2),
        start_time=mtdt(13 * 60), end_time=mtdt(14 * 60)
    ))
    plan.add(Leg(
        seq=5, mode='car', start_area='z', end_area='z',
        start_loc=Point(2, 2), end_loc=Point(1, 1),
        start_time=mtdt(14 * 60), end_time=mtdt(15 * 60)
    ))
    plan.add(Activity(
        seq=6, act='shop', area='z', loc=Point(1, 1),
        start_time=mtdt(15 * 60), end_time=mtdt(17 * 60)
    ))
    plan.add(Leg(
        seq=6, mode='car', start_area='z', end_area='h',
        start_loc=Point(1, 1), end_loc=Point(0, 0),
        start_time=mtdt(17 * 60), end_time=mtdt(18 * 60)
    ))
    plan.add(Activity(
