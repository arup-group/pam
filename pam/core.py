...
class Person:
    ...
    def remove_activity(self, seq) -> tuple:
        """
    ...
    def move_activity(self, seq, default: str = "home", new_mode: str = "walk") -> None:
        """
    ...
    def fill_plan(self, p_idx, s_idx, default: str = "home") -> bool:
        """
